  ...
  div
    ...
    section
      ...
      .description
        ...
        //- p Only tracker for the randomiser that manages to convey as much information as it does in such a compact space while still being aesthetically pleasing.
